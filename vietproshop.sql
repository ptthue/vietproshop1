...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 01, 2018 lúc 04:44 PM
...
(18, 25, 'ádfghjkl', '123456789', 'ádfghjkl', '2017-10-01 01:55:54');
...
(31, 6, 'Lumia-800-Black', 'iphone7-plus-black-select-2016.jpg', '8600000', '12 Năm', 'Hộp, sách, sạc, cáp, tai nghe, ...', 'Máy Mới 1000%', 'Dán Màn Hình 13 lớp', 'Còn hàng', 1, 'Tất cả sản phẩm đều có rất nhiều. Tất cả sản phẩm đều có rất nhiều. Tất cả sản phẩm đều có rất nhiều.</p>\r\n\">');
...
(2, 'sirtuanhoang', 'sirtuanhoang@yahoo.com', 1),
...
--
ALTER TABLE `dmsanpham`
  MODIFY `id_dm` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `thanhvien`
  MODIFY `id_thanhvien` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;COMMIT;
