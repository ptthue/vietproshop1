<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($_FILES['anh_sp']['name']==""){
            ...
            $tmp_anh=$_FILES['anh_sp']['tmp_name'];
        }
        ...
        if(isset($ten_sp) && isset($gia_sp) && isset($bao_hanh) && isset($phu_kien) && isset($tinh_trang) && 
            isset($trang_thai) && isset($chi_tiet_sp) && isset($anh_sp) && isset($id_dm) && isset($dac_biet)){
            ...
            chi_tiet_sp,anh_sp,id_dm,dac_biet) VALUES('$ten_sp','$gia_sp','$bao_hanh','$phu_kien',
            '$tinh_trang','$khuyen_mai','$trang_thai',
